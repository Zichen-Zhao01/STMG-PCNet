...
if __name__ == '__main__':
    model = AGPCNet(backbone='resnet18', scales=(10, 6, 5, 3), reduce_ratios=(16, 4), gca_type='patch', gca_att='post', drop=0.1).to('cuda')
    print(model)
    input = torch.randn(2, 3, 1024, 1024).to('cuda')
    output = model(input)
    print(output.shape)
